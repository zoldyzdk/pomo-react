        ...
        <div className=" p-2 sm:p-10 text-center flex flex-col items-center justify-center">
          <div className="navbar bg-base-100 text-base w-full flex flex-wrap justify-center">
            <button
              onClick={handlePomo}
              className={
                "btn btn-ghost btn-sm normal-case h-1 p-1 " +
                (btnActive === "pomo" ? "btn-active" : "")
              }
            >
              Pomodoro
            </button>
            <button
              onClick={handleShort}
              className={
                "btn btn-ghost normal-case btn-sm p-1 " +
                (btnActive === "short" ? "btn-active" : "")
              }
            >
              Intervalo Curto
            </button>
